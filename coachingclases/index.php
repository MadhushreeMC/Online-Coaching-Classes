...
<body class="agileits_w3layouts">
	    ...
	    <form action="feedback.php" method="post" class="agile_form">
		  <h2>How satisfied were you with our Service?</h2>
			 <ul class="agile_info_select">
				 <li><input type="radio" name="view" value="excellent" id="excellent" > 
			...
			<input type="email"  pattern="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$" placeholder="Your Email (optional)" name="email" required/>
			<input type="text" pattern="^\d{10}$"  placeholder="Your Number " name="num" required /><br>
	...
	<div class="agileits_copyright text-center">
        ...
        <p class="para-1"><span style="color:white;">If You Want To GO Back to home page then press below home button</span></p>
             ...
             <a <span style="color:blue;" href="logout.php">Logout</span></a>
        </center>
</body>
</html>
